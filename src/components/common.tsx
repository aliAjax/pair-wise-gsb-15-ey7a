...
export const Status=({value}:{value:string})=><span className={'status '+value}>{({published:'已发布',draft:'草稿',archived:'已归档',abnormal:'异常',timeout:'超时',running:'进行中',completed:'已完成',high:'高风险',medium:'中风险',low:'低风险',success:'成功',failed:'失败'} as any)[value]||value}</span>;
